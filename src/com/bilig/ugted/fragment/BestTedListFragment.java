...
public class BestTedListFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view=inflater.inflate(R.layout.best_content, container, false);
	...
	private void initView() {
		...
		itemClickListener=new MyOnItemClickListener(this.getActivity());
		lv_list.setOnItemClickListener(itemClickListener);
		
		
		url=Model.BEST_TED+TedConfig.BEST_TED_GET_PARAM+"="
				+TedConfig.BEST_TED_GET_CODE+ "&start=" + mStart + "&end=" + mEnd;
